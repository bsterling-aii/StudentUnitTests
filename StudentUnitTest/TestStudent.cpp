...
{
	// create a student
	Student stu("Jimmy", "13579A1");

	stu.assignGrade("vgp2332", 60);
	stu.assignGrade("vgp2332", 70);
	stu.assignGrade("vgp2332", 70);
	stu.assignGrade("vgp2673", 100);

	CPPUNIT_ASSERT_EQUAL((float)75, stu.findAveGrade());
}